...
<head>
   ...
   @yield('custom-css')
	<title>Anipolls Dashboard</title>
...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">Anipolls Dashboard</span>
        </a>
              ...
              <i class="align-middle" data-feather="check-circle"></i> <span class="align-middle">Polls</span>
					...
					<li class="sidebar-item @yield('nav-profil')">
						<a class="sidebar-link" href="pages-settings.html">
              <i class="align-middle" data-feather="settings"></i> <span class="align-middle">Profil & Pengaturan</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
              ...
              <i class="align-middle" data-feather="search"></i>
                ...
                <img src="{{ asset('img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded mr-1" /> <span class="text-dark">Charles Hall</span>
              </a>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="index.html" class="text-muted"><strong>Anipolls Dashboard</strong></a> &copy;
							</p>
						</div>
					</div>
				</div>
